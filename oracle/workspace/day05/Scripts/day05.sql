...
--PLAYER 테이블에서 TEAM_ID가 '01'인 선수 이름을 내 이름으로 바꾸기
UPDATE PLAYER SET PLAYER_NAME = '김치윤' WHERE TEAM_ID = 'K01';
...
--AS(ALIAS) 별침
--SELECT절과 FROM절에서 시용할 수 있다.
--
--선수 이름과 생일 조회
SELECT PLAYER_NAME AS "선수 이름", BIRTH_DATE 선수생일 FROM PLAYER;

--PLAYER 테이블에서 BACK_NO를 "등 번호"로, MICKNAME을 "선수 별명"으로 변경하여 검색
